...
ladder_maps = [
    ("TerranForce",          LadderCustom, "TerranForceLE", 2),
    ("DefeatBanelings",          LadderCustom, "DefeatBanelings", 2),
    ("TerranForceSoft",          LadderCustom, "TerranForceSoftLE", 2),
    ("TerranForceSoftTriggers",          LadderCustom, "TerranForceSoftTriggersLE", 2),
    ("AbyssalReefCustom",          LadderCustom, "AbyssalReefCustomLE", 2),
