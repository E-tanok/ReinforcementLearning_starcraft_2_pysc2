...
reduce_units_dim = False
units_dim_reduction = 110
...
actions_spectrum = dict_actions_spectrums['blizzard_minigames']
...
'reduce_units_dim':reduce_units_dim, 'convolution_activation':conv_activation, 'dense_activation':dense_activation ,'policy_loss':policy_loss}

dict_default_params = {'resolution':resolution, 'n_workers':n_workers, 'step_mul':step_mul, 'worker_params':dict_worker_params, 'network_params':dict_network_params}

pickle.dump(dict_default_params,open(pickles_path+"dict_default_params.p", "wb"))
